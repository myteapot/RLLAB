...
from src.trainer import train_policy
from src.evaluator import evaluate_policy
from src.checkpoint import CheckpointRegistry
...
class RewardEvolver:
    ...
    def evolve(
        ...
        max_gen = max_generations or evo_config.get("max_generations", 100)
